...
public class FXMLController {
	...
	void corsiPerPeriodo(ActionEvent event) {
		...
		try {
			...
			txtRisultato.setText("Inseriscri un periodo numerico");
			return;
		}

		if (periodoNumerico < 1 || periodoNumerico > 2) {
			txtRisultato.setText("Inseriscri 1 o 2");
			return;
		}
	...
	void numeroStudenti(ActionEvent event) {
		...
		Map<Corso, Integer> corsiIscrizioni = model.getIscrittiByPeriodo(periodoNumerico);
